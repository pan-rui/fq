...
//    private final ConcurrentHashMap<String, Map<String, NamedFilterList>> globalFilterChains = new ConcurrentHashMap<>();
...
/*      List<Map<String,Object>>  tenants= Constants.getCacheValue("system", "dems-" + Table.TENANT, List.class);
      ...
      tenants.forEach(tenant->{
          Map<String, NamedFilterList> filterListMap = new LinkedHashMap<>();
          globalFilterChains.put((String) tenant.get("dbName"), filterListMap);
          super.setFilterChains(filterListMap);
          fillFilterChain();
      }); */                       //TODO:未完待续
        fillFilterChain();
    }
...
/*    public ConcurrentHashMap<String, Map<String, NamedFilterList>> getGlobalFilterChains() {
        return globalFilterChains;
    }*/
}
